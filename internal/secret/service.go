...
func (s *SecretService) GetSecret(context context.Context, id string, password string) (*autogenerated.Secret, int, error) {
	...
	if hashPassword != *secret.Password {
		return nil, http.StatusNotFound, errors.New("incorrect password")
	}
